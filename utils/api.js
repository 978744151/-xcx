...
// 首页弹出红包
const INDEXDATAPARED = 'c=onefive&do=red_packet&m=weisrc_dish&a=get_red';
let getIndexRed = function (parmas) {
  return fetch(INDEXDATAPARED, parmas);
}
// 拆红包
const INDEXGTERED = 'c=onefive&do=red_packet&m=weisrc_dish&a=devanning';
let openRedBack = function (parmas) {
  return fetch(INDEXGTERED, parmas);
}
// 可优化的地方 action值的变动
/**
 * 获取所有的评价
...
// 确认订单
const GREATORDERdATA = 'c=onefive&do=onefiveactiondo&m=weisrc_dish&action=comfirmOrder';
 ...
 * 获取外卖优惠券列表
 */
const WMCOUPONLISTPATH = 'https://op.tiantianremai.cn/wmplus/onefive/couponlist';
const getWmcouponList = function (params) {
  return new Promise((resolve, reject) => {
    wx.request({
      url: WMCOUPONLISTPATH,
      method: 'GET',
      dataType: 'json',
      data: params,
...
// const getWmcouponList = function (params) {
//   return fetch(WMCOUPONLISTPATH, params)
// }
 ...
 * @type {String}
 */
const YUDINGCATEGORYPATH = 'c=onefive&do=onefivecategory&m=weisrc_dish';
 ...
 * @type {String}
 */
const GOODLISTPATH = 'c=onefive&do=onefivegoodslist&m=weisrc_dish';
 ...
 * @type {String}
 */
const YUDIANGOODLISTPATH = 'c=onefive&do=onefivegoodslist&m=weisrc_dish';
...
let goPayMoney = function(params) {
  var PATH = PAYMONEYPATH + '&meal_time=' + params.meal_time + '&orderid=' + params.orderid + '&tablesid=' + params.tablesid + '&access_token=' + params.access_token + '&type=' + params.type + '&money=' + params.money + '&credit=' + params.credit + '&card_id=' + params.card_id + '&coupon_record_id=' + params.coupon_record_id + '&tel=' + params.tel
...
// 大王卡
const coinCard = 'c=onefive&do=onefivedeposit&m=weisrc_dish&a=unicompost';
const getCoinCard = function (params) {
    return fetch(coinCard, params)
}
/**
 * [getIgAddress 获取地址详情]
 * @param  {[type]} parmas [description]
...
module.exports = {
    ...
    getIndexRed: getIndexRed,
    openRedBack:openRedBack,
